...
class WanT2V:
    ...
    def generate(self,
        ...
        with amp.autocast(dtype=self.param_dtype), torch.no_grad(), no_sync():
            ...
            ###########################################
            arg_c = {'context': [context], 'seq_len': seq_len, 'premask': premask, 'premask_text': premask_text, 'visual':False} 
            arg_null = {'context': [context_null], 'seq_len': seq_len, 'premask': premask, 'premask_text': premask_text}

            # arg_c_ori = {'context': [context], 'seq_len': seq_len} 
            # arg_null_ori = {'context': [context_null], 'seq_len': seq_len}
            ...
            for iii, t in enumerate(tqdm(timesteps)):
                ...
                #         latent_model_input, t=timestep, **arg_c_ori)[0]
                #     noise_pred_uncond = self.model(
                #         latent_model_input, t=timestep, **arg_null_ori)[0]
